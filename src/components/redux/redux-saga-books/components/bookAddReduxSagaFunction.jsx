...
import addBookActionCreator from "../actions/addBookActionCreator";

function BookAddReduxSagaFunction(props) {
  ...
  const handleSubmit = (event) => {
    ...
    console.log("newBookProps:", props.newBookProps);
    props.addBookProps(newBook) 
    console.log("newBookProps:", props.newBookProps);
    navigate('/book-store-redux-saga');
  };
...
const mapStateToProps = (state) => {
  return {
      newBookProps: state.data
  }
}

const mapDispatchToProps = (dispatch) => {
  return {
      addBookProps: (newBook)=>dispatch(addBookActionCreator(newBook))
  }
}

export default connect(mapStateToProps, mapDispatchToProps)(BookAddReduxSagaFunction);
